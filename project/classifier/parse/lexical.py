...
class Tokenizer:
    def __init__(self) -> None:
        self.keywords = "if and or not True False count in re topicID phaseID actID topicTurn phaseTurn usr yn who why what when which where how positive negative".split()
        self.symbols = "+ - * / = <= >= < > ( ) : , [ ]".split()
